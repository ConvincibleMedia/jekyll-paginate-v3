...
if 'preserve', then pagination templates are never modified. page 1 is generated as a completely separate page/doc. permalink treatment for pages 2+ is also applied to page 1 (e.g. resulting in ../page/1 -style url)

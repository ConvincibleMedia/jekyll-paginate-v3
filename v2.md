...
- [Jekyll::Paginate V2::Generator](#jekyllpaginate-v2generator)
	- [Site configuration](#site-configuration)
	- [Page configuration](#page-configuration)
	- [Backwards compatibility with jekyll-paginate](#backwards-compatibility-with-jekyll-paginate)
	- [Paginating collections](#paginating-collections)
		- [Paginating a single collection](#paginating-a-single-collection)
		- [Paginating multiple collections](#paginating-multiple-collections)
	...
	- [Offsetting posts](#offsetting-posts)
	- [Advanced Sorting](#advanced-sorting)
	- [Creating Pagination Trails](#creating-pagination-trails)
	- [Detecting generated pagination pages](#detecting-generated-pagination-pages)
	- [Formatting page titles](#formatting-page-titles)
	- [Reading pagination meta information](#reading-pagination-meta-information)
	- [Generating a JSON API](#generating-a-json-api)
		- [So how do I generate a JSON API for Jekyll?](#so-how-do-i-generate-a-json-api-for-jekyll)
		- [How did you generate those 'next', 'prev' and 'first' links?](#how-did-you-generate-those-next-prev-and-first-links)
	- [Renaming pagination file names](#renaming-pagination-file-names)
	- [Common issues](#common-issues)
		- [I keep getting a dependency error when running jekyll serve after installing this gem](#i-keep-getting-a-dependency-error-when-running-jekyll-serve-after-installing-this-gem)
		- [I'm getting a bundler error after upgrading the gem (Bundler::GemNotFound)](#im-getting-a-bundler-error-after-upgrading-the-gem-bundlergemnotfound)
		- [I'm getting a bundler error after upgrading the gem (Gem::LoadError)](#im-getting-a-bundler-error-after-upgrading-the-gem-gemloaderror)
		- [My pagination pages are not being found (Couldn't find any pagination page. Skipping pagination)](#my-pagination-pages-are-not-being-found-couldnt-find-any-pagination-page-skipping-pagination)
		- [My pages are being nested multiple levels deep](#my-pages-are-being-nested-multiple-levels-deep)
		- [My pagination pages are overwriting each others pages](#my-pagination-pages-are-overwriting-each-others-pages)
- [Jekyll::Paginate V2::AutoPages](#jekyllpaginate-v2autopages)
	- [Site configuration](#site-configuration-1)

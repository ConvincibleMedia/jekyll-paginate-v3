...
require 'jekyll-paginate-v3/templates/grouped_index/numeric_and_datetime_entries'
require 'jekyll-paginate-v3/templates/grouped_index/alphabetic_and_shared_helpers'
